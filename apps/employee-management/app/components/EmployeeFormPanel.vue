...
import { employeeFormSchema, type Employee, type EmployeeFormInput } from '@shireburn-platform/shared'
import { reactive, ref, watch } from 'vue'

const props = defineProps<{ employee?: Employee | null; open: boolean, portal?: boolean }>()
