...
import { formatSalary, type Employee, type EmployeeFormInput, type EmployeeSortField } from '@shireburn-platform/shared'
...
onMounted(() => {
  cleanupFloatingActions = registerFloatingActions({
    ...
    'employees:import': () => importInput.value?.click(),
    'employees:export': exportEmployeeData
  })
})
...
<template>
  <section class="space-y-4">
    ...
    <EmployeeFormPanel :open="panelOpen" :employee="selectedEmployee" @close="panelOpen = false" @submit="saveEmployee" portal />
  </section>
</template>
